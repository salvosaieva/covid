...
const backgroundShape = require("../images/covid.jpg");
                  ...
                  <Paper className={classes.paper}>
                    <div>
                      <Typography
                        ...
                        gutterBottom
                      >
                        Panoramica dati nazionali
                      </Typography>
                      <div>I Dati sono messi a disposizione dalla <a href="https://github.com/pcm-dpc/COVID-19" target="_blank">Presidenza del Consiglio dei Ministri e dalla Protezione civile</a></div>
                  ...
                  <Grid item xs={12}>
                    <Paper className={classes.paper}>
                      <div>
                        ...
                        <Typography variant="body1" gutterBottom>Ricoverati sintomatici: {this.incPerc(array, index, "ricoverati_con_sintomi")}</Typography>
                        <Typography variant="body1" gutterBottom>Terapia intensiva: {this.incPerc(array, index, "terapia_intensiva")}</Typography>
                        <Typography variant="body1" gutterBottom>Totale Ospedalizzati: {this.incPerc(array, index, "totale_ospedalizzati")}</Typography>
                        <Typography variant="body1" gutterBottom>Domiciliare: {this.incPerc(array, index, "isolamento_domiciliare")}</Typography>
                        <Typography variant="body1" gutterBottom>Totale positivi: {this.incPerc(array, index, "totale_attualmente_positivi")}</Typography>
                        <Typography variant="body1" gutterBottom>Totale nuovi positivi: {this.incPerc(array, index, "nuovi_attualmente_positivi")}</Typography>
                        ...
                        <Typography variant="body1" gutterBottom>Totale casi: {this.incPerc(array, index, "totale_casi")}</Typography>
